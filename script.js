https API = "https://script.google.com/macros/s/AKfycbx4ZCK1l1cNu0FmyHw1InEsz2v_U3OLoOBqebPXPZHKAAoyn2KM_gQOSS4wxlI01Bc/exec";
...
async function donate() {
  ...
  try {
    ...
    box.innerHTML = `🎁 ${name} สนับสนุน ${amount} บาท 😸 ขอบคุณสำหรับค่าขนม 🩵`;
...
async function loadGoal() {
  try {
    ...
    console.error(err);
    document.getElementById("goalText").innerText = "โหลดข้อมูลไม่สำเร็จ";
  }
}
